...
//  MessageBoxW(0, cmdnameBufW, L"right DllMain called", 0);
#endif

  switch (reason)
    {
    case DLL_PROCESS_ATTACH:
      __mingwthr_key_dtor_ptr = __mingwthr_key_dtor;
      __mingwthr_remove_key_dtor_ptr = __mingwthr_remove_key_dtor;
    ...
    case DLL_PROCESS_DETACH:
      ...
      __mingwthr_key_dtor_ptr = 0;
      __mingwthr_remove_key_dtor_ptr = 0;
      break;
