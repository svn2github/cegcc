...
__IMPORT int optind = 1;

/* Formerly, initialization of getopt depended on optind==0, which
   causes problems with re-calling getopt as programs generally don't
   know that. */

__IMPORT int __getopt_initialized;
...
# if HAVE_STRING_H || defined (UNDER_CE)
#  include <string.h>
# else
#  include <strings.h>
# endif
...
extern __IMPORT int strlen (const char *);
# endif /* not __STDC__ */
#endif /* __GNUC__ */
...
extern __IMPORT int __argc;
extern __IMPORT char **__argv;
...
extern __IMPORT char *__getopt_nonoption_flags;
